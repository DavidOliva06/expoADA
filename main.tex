...
% =====================================================
% INTEGRANTE 4 — Criterios de aceptación y sus variantes
% =====================================================
...
\begin{frame}{Pseudocódig del ILS\_RW con criterio de aceptación \textit{Random Walk}}
\begin{columns}[T]
\begin{column}{0.55\textwidth}
...
% -----------------------------------------------------
\begin{frame}{Pseudocódigo del ILS\_SA (criterio Simulated Annealing — equilibrio I)}
...
\begin{frame}{Criterio de aceptación Simulated Annealing — equilibrio II}
